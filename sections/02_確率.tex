...
\begin{proof}\mbox{}\\
    ...
    \begin{alignanswer*}
        ...
        &= \dfrac{13}{729}
    \end{alignanswer*}
    \vspace{-5\baselineskip}%  この証明環境の空行をさらに減らす
\end{proof}
\vspace{-1.5em}%  証明環境間の空行をさらに減らす
...
\subsection{条件付き確率}
    ...
    \begin{definitionbox}{条件付き確率}{\textbf{条件付き確率}}
        ...
        \end{align}
    \end{definitionbox}
    \vspace{-0.5em}%  定義環境と定理環境間の空行を減らす
...
\end{techniquebox}
\vspace{-1em}%  テクニックボックスと証明環境間の空行を減らす
...
\begin{proof}\mbox{}\\
    ...
    \end{alignanswer*}
    \vspace{-4\baselineskip}%  証明環境の空行を減らす
\end{proof}
\newpage
...
\begin{proof}\mbox{}\\
    ...
    \vspace{-4\baselineskip}%  証明環境の空行を減らす
\end{proof}
\vspace{-1em}%  証明環境と練習問題環境間の空行を減らす
